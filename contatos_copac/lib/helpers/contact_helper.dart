...
final String idColumn = "idDolumn";
final String nameColumn = "nameDolumn";
final String emailColumn = "emailDolumn";
final String phoneColumn = "phoneDolumn";
final String imageColumn = "imageDolumn";
